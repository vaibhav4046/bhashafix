...
function localeProfile(tag) {
  ...
  const pluralCategories = new Intl.PluralRules(canonical).resolvedOptions().pluralCategories;
  return {
    requested: tag,
    canonical,
    ...
    expansionRisk: COMPACT_SCRIPTS.has(script) ? "low" : TALL_GLYPH_SCRIPTS.has(script) ? "medium" : "high",
    lineBreaking: CHARACTER_BREAK_SCRIPTS.has(script) ? "character" : DICTIONARY_BREAK_SCRIPTS.has(script) ? "dictionary" : "spaces",
    segmentation: CHARACTER_BREAK_SCRIPTS.has(script) ? "grapheme" : DICTIONARY_BREAK_SCRIPTS.has(script) ? "dictionary" : "word",
    pluralCategories: [...pluralCategories],
    fontStack: SCRIPT_FONT_STACKS[script] ?? '"Noto Sans", Inter, system-ui, -apple-system, sans-serif'
  };
}
function formatLocaleSample(tag) {
  const date = /* @__PURE__ */ new Date("2026-07-29T12:00:00Z");
  return {
    number: new Intl.NumberFormat(tag).format(123456789e-2),
...
var RTL_SCRIPTS, CHARACTER_BREAK_SCRIPTS, DICTIONARY_BREAK_SCRIPTS, TALL_GLYPH_SCRIPTS, COMPACT_SCRIPTS, SCRIPT_FONT_STACKS, REPRESENTATIVE_LOCALE_MATRIX;
var init_src = __esm({
  "../locale-engine/src/index.ts"() {
    "use strict";
    RTL_SCRIPTS = /* @__PURE__ */ new Set(["Arab", "Hebr", "Thaa", "Nkoo", "Adlm", "Syrc"]);
    CHARACTER_BREAK_SCRIPTS = /* @__PURE__ */ new Set(["Hans", "Hant", "Jpan", "Kore"]);
    DICTIONARY_BREAK_SCRIPTS = /* @__PURE__ */ new Set(["Thai", "Laoo", "Khmr", "Mymr"]);
    TALL_GLYPH_SCRIPTS = /* @__PURE__ */ new Set(["Deva", "Taml", "Thai", "Ethi"]);
    COMPACT_SCRIPTS = /* @__PURE__ */ new Set(["Hans", "Hant", "Jpan", "Kore"]);
    SCRIPT_FONT_STACKS = {
...
var ScanOriginSchema, ScanStatusSchema, IssueCategorySchema, SeveritySchema, ConfidenceSchema, VerificationStatusSchema, ViewportSchema, IssueSchema, ScanConfigSchema, ScanSchema, RepairOperationSchema, RepairPlanSchema, VerificationResultSchema, DEFAULT_VIEWPORTS, ENGINE_VERSION, RULE_CATEGORIES;
var init_src2 = __esm({
  "../shared/src/index.ts"() {
    "use strict";
    init_zod();
    ...
    ScanStatusSchema = external_exports.enum([
      "draft",
      "queued",
      "validating",
      "discovering",
    ...
    IssueCategorySchema = external_exports.enum([
      "visual",
      "locale",
      "linguistic",
      "accessibility",
    ...
    ConfidenceSchema = external_exports.enum([
      "verified",
      "high",
      "medium",
      "low",
    ...
    VerificationStatusSchema = external_exports.enum([
      "unverified",
      "verification failed",
    ...
    ScanConfigSchema = external_exports.object({
      projectRoot: external_exports.string().min(1),
      url: external_exports.string().url().optional(),
      sourceLocale: external_exports.string().min(2),
      locales: external_exports.array(external_exports.string().min(2)).min(1),
      routes: external_exports.array(external_exports.string().startsWith("/")).min(1),
      viewports: external_exports.array(ViewportSchema).min(1),
      browsers: external_exports.array(external_exports.enum(["chromium", "firefox", "webkit"])).min(1),
      themes: external_exports.array(external_exports.enum(["light", "dark"])).min(1),
      maxPages: external_exports.number().int().min(1).max(100).default(20),
      maxDepth: external_exports.number().int().min(0).max(5).default(2),
      rateLimitPerSecond: external_exports.number().positive().max(10).default(2),
      noAi: external_exports.boolean().default(true),
      hosted: external_exports.boolean().default(false),
      allowLocalhost: external_exports.boolean().default(false),
      allowlist: external_exports.array(external_exports.string()).default([])
    });
    ScanSchema = external_exports.object({
      scanId: external_exports.string().min(1),
      origin: ScanOriginSchema,
      ...
      routesDiscovered: external_exports.array(external_exports.string()),
      localesTested: external_exports.array(external_exports.string()),
      engineVersion: external_exports.string(),
      mode: external_exports.enum(["live", "replay"])
    });
    RepairOperationSchema = external_exports.object({
      issueId: external_exports.string().min(1),
      file: external_exports.string().min(1),
      pointer: external_exports.array(external_exports.string()).min(1),
      before: external_exports.unknown(),
      after: external_exports.unknown(),
      reason: external_exports.string().min(1)
    });
    RepairPlanSchema = external_exports.object({
      scanId: external_exports.string().min(1),
      createdAt: external_exports.string().datetime(),
      projectRoot: external_exports.string().min(1),
      allowlist: external_exports.array(external_exports.string()).min(1),
      operations: external_exports.array(RepairOperationSchema).min(1),
      unifiedDiff: external_exports.string()
    });
    VerificationResultSchema = external_exports.object({
      scanId: external_exports.string().min(1),
      verifiedAt: external_exports.string().datetime(),
      status: VerificationStatusSchema,
      baselineBlocking: external_exports.number().int().nonnegative(),
      finalBlocking: external_exports.number().int().nonnegative(),
      sourceLocaleRegression: external_exports.enum(["PASS", "FAIL"]),
      consoleErrorDelta: external_exports.number().int(),
      accessibilityRegression: external_exports.boolean(),
      newBlockingIssues: external_exports.number().int().nonnegative(),
      diffWithinPolicy: external_exports.boolean()
    });
    DEFAULT_VIEWPORTS = [
...
function placeholderMismatch(source, target) {
...
function checkGlossary(source, target, locale, entries) {
  const findings = [];
  for (const entry of entries) {
    const sourceHaystack = entry.caseSensitive ? source : source.toLowerCase();
    const sourceNeedle = entry.caseSensitive ? entry.source : entry.source.toLowerCase();
    ...
    const matches = entry.caseSensitive ? target.includes(expected) : target.toLowerCase().includes(expected.toLowerCase());
    const forbidden = (entry.forbidden?.[locale] ?? []).find(
      (alternative) => target.toLowerCase().includes(alternative.toLowerCase())
    );
    if (!matches || forbidden) {
      findings.push({
        ...
        expected,
        actual: target,
        reason: forbidden ? `Forbidden alternative "${forbidden}" was used` : `Approved term "${expected}" is missing`
      });
    }
  }
  return findings;
...
var TOKEN_PATTERN, ACCENTS;
var init_src3 = __esm({
  "../linguistic-engine/src/index.ts"() {
    "use strict";
    TOKEN_PATTERN = /(\{\{[^{}]+\}\}|\{[A-Za-z_][^{}]*\}|%[sdif]|<\/?[A-Za-z][^>]*>|https?:\/\/[^\s]+|[\w.+-]+@[\w.-]+\.[A-Za-z]{2,})/g;
    ACCENTS = {
      a: "\xE1",
      e: "\xEB",
      i: "\xEF",
...
function valueAt(state, pointer) {
  let current = state;
...
var PathSchema, RepairSchema, BaseSchema, PredicateSchema;
var init_src4 = __esm({
  "../visual-engine/src/index.ts"() {
    "use strict";
    init_src3();
    init_zod();
    PathSchema = external_exports.array(external_exports.string().min(1)).min(1);
    RepairSchema = external_exports.object({
      file: external_exports.string().min(1),
      pointer: PathSchema,
      after: external_exports.unknown()
    });
    BaseSchema = external_exports.object({
      issueId: external_exports.string(),
      category: external_exports.string(),
      locale: external_exports.string(),
      route: external_exports.string().startsWith("/"),
      selector: external_exports.string(),
      sourceHint: external_exports.string(),
      description: external_exports.string(),
      recommendedAction: external_exports.string(),
      repair: RepairSchema
    });
    PredicateSchema = external_exports.discriminatedUnion("predicate", [
      BaseSchema.extend({
        predicate: external_exports.literal("numeric-gte"),
        actual: PathSchema,
        expected: PathSchema
      }),
      BaseSchema.extend({
        predicate: external_exports.literal("equals"),
        actual: PathSchema,
        value: external_exports.unknown()
      }),
      BaseSchema.extend({
        predicate: external_exports.literal("not-equals"),
        actual: PathSchema,
        value: external_exports.unknown()
      }),
      BaseSchema.extend({
        predicate: external_exports.literal("equals-path"),
        actual: PathSchema,
        expected: PathSchema
      }),
      BaseSchema.extend({
        predicate: external_exports.literal("placeholder-parity"),
        source: PathSchema,
        target: PathSchema
      })
    ]);
...
async function loadDemoState(projectRoot) {
...
async function loadDemoPredicates(projectRoot) {
...
function scanFingerprint(state, predicates) {
  return createHash("sha256").update(JSON.stringify({ state, predicates, engine: ENGINE_VERSION })).digest("hex").slice(0, 12);
}
async function scanDemoProject(projectRoot, options = {}) {
  const started = options.now ?? /* @__PURE__ */ new Date();
...
async function inspectProject(projectRoot) {
  ...
  const framework = dependencies.next ? "nextjs" : dependencies["@remix-run/react"] ? "remix-experimental" : dependencies.astro ? "astro-experimental" : dependencies.nuxt ? "nuxt-experimental" : dependencies.vue ? "vue-vite-experimental" : dependencies["@sveltejs/kit"] ? "sveltekit-experimental" : dependencies.react && dependencies.vite ? "react-vite-experimental" : "static-html-experimental";
  return {
    projectRoot,
    framework,
...
var PredicateListSchema, DEMO_FILES;
var init_src5 = __esm({
  "../core/src/index.ts"() {
    "use strict";
    init_src();
    ...
    init_zod();
    init_src2();
    PredicateListSchema = external_exports.array(PredicateSchema).min(1);
    DEMO_FILES = {
...
async function validateTargetUrl(input, policy) {
  let url;
  try {
    url = new URL(input);
  } catch {
  ...
  if (addresses.some(({ address }) => isPrivateAddress(address)) && !(policy.allowLocalhost && !policy.hosted)) {
    throw new Error("Private-network destinations are blocked.");
  }
  return url;
}
async function fetchWithPolicy(input, policy) {
  const timeoutMs = policy.timeoutMs ?? 12e3;
  const redirectLimit = policy.redirectLimit ?? 5;
  const maxBytes = policy.maxBytes ?? 2e6;
...
function stableStringId(route, selector, text2) {
  return `str_${createHash2("sha256").update(`${route}\0${selector}\0${text2}`).digest("hex").slice(0, 16)}`;
}
function extractTextFromHtml(html, route) {
  const withoutSecrets = html.replace(
    /\s([A-Za-z0-9:_-]+)=["'][^"']*["']/g,
    (full, name) => SENSITIVE_ATTRIBUTE.test(name) ? "" : full
  );
  const title = withoutSecrets.match(/<title[^>]*>([\s\S]*?)<\/title>/i)?.[1];
  const results = [];
  const pattern = /<(h[1-6]|p|button|a|label|option|textarea|span)[^>]*>([\s\S]*?)<\/\1>/gi;
  let match;
  let index = 0;
  while (match = pattern.exec(withoutSecrets)) {
    const text2 = redactSecrets(
      match[2].replace(/<[^>]+>/g, " ").replace(/\s+/g, " ").trim()
    );
    if (!text2) continue;
    const selector = `${match[1].toLowerCase()}:nth-of-type(${++index})`;
    results.push({
      stringId: stableStringId(route, selector, text2),
      text: text2,
      route,
      selector,
...
function assertAllowlisted(file, allowlist) {
...
function assertConfinedPath(projectRoot, file) {
  const root = path3.resolve(projectRoot);
  const target = path3.resolve(root, file);
...
async function assertNoSymlink(projectRoot, target) {
  const rootReal = await realpath(projectRoot);
  const parentReal = await realpath(path3.dirname(target));
  const relative = path3.relative(rootReal, parentReal);
  if (relative.startsWith("..") || path3.isAbsolute(relative)) {
...
function unifiedDiff(operations) {
...
async function prepareRepair(projectRoot, scan) {
  ...
  for (const predicate of predicates) {
    ...
    const json = JSON.parse(await readFile3(target, "utf8"));
    operations.push({
      issueId: predicate.issueId,
...
async function applyRepair(plan, options = {}) {
  RepairPlanSchema.parse(plan);
  const selected = options.issueIds ? plan.operations.filter(
    (operation) => options.issueIds.includes(operation.issueId)
  ) : plan.operations;
...
async function verifyRepair(projectRoot, baseline) {
  ...
  const result = VerificationResultSchema.parse({
    ...
    status: finalBlocking === 0 && sourceLocaleRegression === "PASS" ? "verified" : "verification failed",
    baselineBlocking,
    finalBlocking,
    ...
    newBlockingIssues: scan.issues.filter(
      (issue) => issue.severity === "blocking" && !baseline.issues.some((before) => before.issueId === issue.issueId)
    ).length,
...
// ../../node_modules/.pnpm/@modelcontextprotocol+sdk@1.17.5/node_modules/@modelcontextprotocol/sdk/dist/esm/types.js
...
// ../../node_modules/.pnpm/@modelcontextprotocol+sdk@1.17.5/node_modules/@modelcontextprotocol/sdk/dist/esm/shared/protocol.js
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/compile/ucs2length.js
var require_ucs2length = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/compile/ucs2length.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/compile/util.js
var require_util = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/compile/util.js"(exports, module) {
    "use strict";
    module.exports = {
      copy,
      checkDataType,
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/compile/schema_obj.js
var require_schema_obj = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/compile/schema_obj.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/compile/resolve.js
var require_resolve = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/compile/resolve.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/compile/error_classes.js
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/validate.js
var require_validate = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/validate.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/compile/index.js
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/cache.js
var require_cache = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/cache.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/compile/formats.js
var require_formats = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/compile/formats.js"(exports, module) {
    "use strict";
    var util2 = require_util();
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/ref.js
var require_ref = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/ref.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/allOf.js
var require_allOf = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/allOf.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/anyOf.js
var require_anyOf = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/anyOf.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/comment.js
var require_comment = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/comment.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/const.js
var require_const = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/const.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/contains.js
var require_contains = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/contains.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/dependencies.js
var require_dependencies = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/dependencies.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/enum.js
var require_enum = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/enum.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/format.js
var require_format = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/format.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/if.js
var require_if = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/if.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/items.js
var require_items = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/items.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/_limit.js
var require_limit = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/_limit.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/_limitItems.js
var require_limitItems = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/_limitItems.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/_limitLength.js
var require_limitLength = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/_limitLength.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/_limitProperties.js
var require_limitProperties = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/_limitProperties.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/multipleOf.js
var require_multipleOf = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/multipleOf.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/not.js
var require_not = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/not.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/oneOf.js
var require_oneOf = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/oneOf.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/pattern.js
var require_pattern = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/pattern.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/properties.js
var require_properties = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/properties.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/propertyNames.js
var require_propertyNames = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/propertyNames.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/required.js
var require_required = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/required.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/uniqueItems.js
var require_uniqueItems = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/uniqueItems.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/index.js
var require_dotjs = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/index.js"(exports, module) {
    "use strict";
    module.exports = {
      "$ref": require_ref(),
      allOf: require_allOf(),
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/compile/rules.js
var require_rules = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/compile/rules.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/data.js
var require_data = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/data.js"(exports, module) {
    "use strict";
    var KEYWORDS = [
      "multipleOf",
      "maximum",
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/compile/async.js
var require_async = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/compile/async.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/custom.js
var require_custom = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/dotjs/custom.js"(exports, module) {
    "use strict";
...
var require_json_schema_draft_07 = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/refs/json-schema-draft-07.json"(exports, module) {
    module.exports = {
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/definition_schema.js
var require_definition_schema = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/definition_schema.js"(exports, module) {
    "use strict";
...
// ../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/keyword.js
var require_keyword = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/keyword.js"(exports, module) {
    "use strict";
...
var require_data2 = __commonJS({
  "../../node_modules/.pnpm/ajv@6.15.0/node_modules/ajv/lib/refs/data.json"(exports, module) {
    module.exports = {
      $schema: "http://json-schema.org/draft-07/schema#",
...
// ../../node_modules/.pnpm/@modelcontextprotocol+sdk@1.17.5/node_modules/@modelcontextprotocol/sdk/dist/esm/server/index.js
...
// ../../node_modules/.pnpm/@modelcontextprotocol+sdk@1.17.5/node_modules/@modelcontextprotocol/sdk/dist/esm/server/completable.js
...
// ../../node_modules/.pnpm/@modelcontextprotocol+sdk@1.17.5/node_modules/@modelcontextprotocol/sdk/dist/esm/shared/uriTemplate.js
...
// ../../node_modules/.pnpm/@modelcontextprotocol+sdk@1.17.5/node_modules/@modelcontextprotocol/sdk/dist/esm/server/mcp.js
...
// ../../node_modules/.pnpm/@modelcontextprotocol+sdk@1.17.5/node_modules/@modelcontextprotocol/sdk/dist/esm/shared/stdio.js
...
// ../../node_modules/.pnpm/@modelcontextprotocol+sdk@1.17.5/node_modules/@modelcontextprotocol/sdk/dist/esm/server/stdio.js
...
function planHash(unifiedDiff2) {
  return createHash3("sha256").update(unifiedDiff2).digest("hex");
}
function createMcpServer(projectRoot = process.cwd()) {
  ...
  server.registerTool(
    "bhashafix_list_locales",
    {
      ...
      inputSchema: { locales: external_exports.array(external_exports.string()).optional() }
    },
    async ({ locales }) => text((locales ?? [...REPRESENTATIVE_LOCALE_MATRIX]).map(localeProfile))
  );
  server.registerTool(
    "bhashafix_crawl_routes",
    {
      ...
      inputSchema: {
        ...
        localMode: external_exports.boolean().default(false)
      }
    },
    async ({ url, localMode }) => {
  ...
  server.registerTool(
    "bhashafix_extract_strings",
    {
      ...
      inputSchema: {
        html: external_exports.string().max(2e6),
        route: external_exports.string().startsWith("/")
      }
    },
  ...
  server.registerTool(
    "bhashafix_scan_project",
    {
      ...
      inputSchema: { mode: external_exports.enum(["live", "replay"]).default("live") }
    },
    async ({ mode }) => {
  ...
  server.registerTool(
    "bhashafix_check_translation",
    {
      ...
      inputSchema: {
        ...
        locale: external_exports.string(),
        approvedTerm: external_exports.string().optional()
      }
    },
    async ({ source, target, locale, approvedTerm }) => text({
      locale: localeProfile(locale),
      placeholders: placeholderMismatch(source, target),
      glossary: approvedTerm ? checkGlossary(source, target, locale, [
  ...
  for (const name of [
    ...
    server.registerTool(
      name,
      {
        ...
        inputSchema: {
          source: external_exports.string(),
          sourceLocale: external_exports.string(),
          targetLocale: external_exports.string(),
          context: external_exports.string().optional()
        }
      },
      async ({ sourceLocale, targetLocale }) => text(
        {
          status: "provider unavailable",
          sourceLocale,
          targetLocale,
          deterministicChecksAvailable: true,
          message: "No model provider is configured. No translation was fabricated."
        },
        true
      )
    );
  ...
  server.registerTool(
    "bhashafix_prepare_repair",
    {
      ...
      inputSchema: {
        scanId: external_exports.string().min(1),
        issueIds: external_exports.array(external_exports.string().min(1)).min(1)
      }
    },
  ...
  server.registerTool(
    "bhashafix_apply_repair",
    {
      ...
      inputSchema: {
        ...
        confirmedDiffHash: external_exports.string().optional()
      },
  ...
  server.registerTool(
    ...
    async ({ scanId }) => text((await verifyRepair(projectRoot, await loadScan(projectRoot, scanId))).result)
  );
  server.registerTool(
    "bhashafix_generate_report",
    {
      ...
      inputSchema: {
        scanId: external_exports.string().min(1),
        outputDirectory: external_exports.string().default("artifacts/report")
      }
    },
        ...
        contents: [
          {
            uri,
            mimeType: "text/plain",
            text: await readFile4(path5.join(projectRoot, relative), "utf8").catch(
  ...
  server.registerResource(
    "scan",
    new ResourceTemplate("bhashafix://scans/{scanId}", { list: void 0 }),
  ...
  server.registerResource(
    "issue",
    new ResourceTemplate("bhashafix://issues/{issueId}", { list: void 0 }),
  ...
  server.registerResource(
    "report",
    new ResourceTemplate("bhashafix://reports/{scanId}", { list: void 0 }),
  ...
  for (const [name, prompt] of Object.entries(prompts)) {
    server.registerPrompt(
      name,
      { description: prompt, argsSchema: { project: external_exports.string().optional() } },
      async ({ project }) => ({
        messages: [
          {
            role: "user",
...
async function startMcpServer(projectRoot = process.cwd()) {
...
var init_server2 = __esm({
  async "../mcp/src/server.ts"() {
    ...
    init_stdio2();
    init_zod();
    isEntrypoint = process.argv[1] && path5.resolve(process.argv[1]) === path5.resolve(fileURLToPath(import.meta.url));
    if (isEntrypoint) {
...
var ProjectConfigSchema = external_exports.object({
  ...
  locales: external_exports.array(external_exports.string().min(2)).min(1),
  routes: external_exports.array(external_exports.string().startsWith("/")).min(1),
  browsers: external_exports.array(external_exports.enum(["chromium", "firefox", "webkit"])).default(["chromium"]),
  viewports: external_exports.array(external_exports.enum(["mobile", "tablet", "desktop", "narrow"])).default(["mobile", "desktop"]),
  themes: external_exports.array(external_exports.enum(["light", "dark"])).default(["light", "dark"]),
  severity: external_exports.enum(["blocking", "warning", "advisory"]).default("blocking"),
  noAi: external_exports.boolean().default(true),
  crawl: external_exports.object({
    maxPages: external_exports.number().int().min(1).max(100).default(20),
    maxDepth: external_exports.number().int().min(0).max(5).default(2),
    rateLimitPerSecond: external_exports.number().positive().max(10).default(2),
    respectRobots: external_exports.boolean().default(true)
  }).default({}),
  repair: external_exports.object({ allowlist: external_exports.array(external_exports.string()).default([]) }).default({})
});
async function loadProjectConfig(projectRoot, relativePath = ".bhashafix/config.yml") {
  const file = path2.resolve(projectRoot, relativePath);
  const parsed = YAML.parse(await readFile2(file, "utf8"));
...
var HELP = `BhashaFix \u2014 test, repair and prove every language before release
...
function parseArgs(args) {
  ...
  for (let index = 1; index < args.length; index += 1) {
    ...
    if (args[index] === "--project" && value) options.project = path6.resolve(value);
...
function emit(io, options, value, human) {
  if (options.quiet) return;
  io.out(options.json ? JSON.stringify(value, null, 2) : human);
}
async function initialise(projectRoot) {
  const directory = path6.join(projectRoot, ".bhashafix");
  await mkdir4(path6.join(directory, "locale-rules"), { recursive: true });
  const files = {
...
`,
  ...
  await Promise.all(
    Object.entries(files).map(
      ([name, contents]) => writeFile4(path6.join(directory, name), contents, { flag: "wx" }).catch(
        (error) => {
...
async function readBaseline(projectRoot) {
  const file = path6.join(projectRoot, ".bhashafix", "baseline-scan.json");
  return JSON.parse(await readFile5(file, "utf8"));
}
async function scanLocalProject(projectRoot, options) {
  const scan = await scanDemoProject(projectRoot, {
    mode: "live",
  ...
  if (options?.locales) {
    scan.issues = scan.issues.filter(
      (issue) => options.locales.includes(issue.locale)
    );
    scan.localesTested = scan.localesTested.filter(
      (locale) => options.locales.includes(locale)
    );
    scan.config.locales = options.locales;
  }
  if (options?.routes) {
    scan.issues = scan.issues.filter(
      (issue) => options.routes.includes(issue.route)
    );
    scan.routesDiscovered = scan.routesDiscovered.filter(
      (route) => options.routes.includes(route)
    );
    scan.config.routes = options.routes;
  }
  if (options?.viewports) {
    scan.config.viewports = scan.config.viewports.filter(
      (viewport) => options.viewports.includes(viewport.name)
    );
  }
...
Unknown scripts require approval before execution.`
    ...
    if (command === "locales") {
      ...
      emit(
        ...
        registry.map(
          (locale) => `${locale.canonical.padEnd(12)} ${locale.script} ${locale.direction} ${locale.sample.date}`
        ).join("\n")
      );
      return EXIT.passed;
    }
    if (command === "crawl" || command === "extract") {
      ...
      const value = command === "crawl" ? { url: response.url, status: response.status, routes: [new URL(response.url).pathname] } : { url: response.url, strings };
      emit(
        io,
        options,
        value,
        command === "crawl" ? `Crawled ${response.url} (${response.status}).` : `Extracted ${strings.length} contextual strings.`
      );
      return response.status >= 400 ? EXIT.unavailable : EXIT.passed;
    }
    if (command === "scan") {
      const scan = await scanLocalProject(options.project, options);
      await mkdir4(path6.join(options.project, ".bhashafix"), { recursive: true });
      await writeFile4(
        path6.join(options.project, ".bhashafix", "baseline-scan.json"),
        `${JSON.stringify(scan, null, 2)}
`
      );
      if (options.output) {
        await writeFile4(path6.resolve(options.output), `${JSON.stringify(scan, null, 2)}
`);
      }
      emit(
        io,
...
${scan.issues.length} verified blocking issue(s) across ${scan.routesDiscovered.length} routes and ${scan.localesTested.length} locales.`
    ...
    if (command === "issues" || command === "diagnose") {
      ...
      emit(
        ...
        scan.issues.map(
          (issue) => `${issue.issueId} ${issue.locale} ${issue.route} \u2014 ${issue.description}`
        ).join("\n")
      );
    ...
    if (command === "translate-preview") {
      ...
      const profile = localeProfile(targetLocale);
      const mode = options.pseudoMode ?? (profile.direction === "rtl" ? "rtl-mirrored" : "expanded-latin");
      ...
      emit(
        ...
        preview,
        `${preview.label}
${preview.targetLocale} \xB7 ${preview.direction} \xB7 ${preview.mode}
${preview.target}`
      );
    ...
    if (command === "repair") {
      ...
      if (options.output) await writeFile4(path6.resolve(options.output), plan.unifiedDiff);
      emit(
        io,
        options,
        { plan, result },
...
${plan.unifiedDiff}`
    ...
    if (command === "report") {
      const scan = await scanLocalProject(options.project, options);
      const output = path6.resolve(options.output ?? "artifacts/report");
    ...
    if (command === "ci") {
      ...
      if (options.output) {
        ...
        await mkdir4(path6.dirname(output), { recursive: true });
        await writeFile4(output, `${JSON.stringify(ciResult, null, 2)}
`);
      }
      emit(
        io,
    ...
    if (command === "mcp") {
      const { startMcpServer: startMcpServer2 } = await init_server2().then(() => server_exports);
...
var isEntrypoint2 = process.argv[1] && path6.resolve(process.argv[1]) === path6.resolve(fileURLToPath2(import.meta.url));
if (isEntrypoint2) {
